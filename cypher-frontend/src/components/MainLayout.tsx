...
import { Github, Home, LogOut, Settings, Folder, Play, PanelLeftClose, PanelRightClose, Menu, X, Box } from 'lucide-react';
        ...
        >
          ...
          {user && (
            <div className="p-4 border-t border-sidebar-border flex-shrink-0">
              <div className={cn("flex items-center mb-3", isCollapsed ? "flex-col space-y-2 items-center" : "justify-between")}>
                 <Tooltip>
                   <TooltipTrigger asChild>
                 ...
                 {!isCollapsed && (
                   <div className="flex-1 overflow-hidden ml-3">
                     <p className="text-sm font-medium truncate whitespace-nowrap">{user.name || user.login}</p>
                     <p className="text-xs text-sidebar-foreground/70 truncate whitespace-nowrap">{user.login}</p>
                   </div>
                 )}
                 <ThemeToggle />
              </div>
          ...
          <div className="p-4 border-t border-sidebar-border flex-shrink-0">
             <Tooltip>
               <TooltipTrigger asChild>
                 ...
                 >
                   {isCollapsed ? <PanelRightClose size={16} className="flex-shrink-0"/> : <PanelLeftClose size={16} className="flex-shrink-0"/>}
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="md:hidden bg-sidebar text-sidebar-foreground p-4 flex items-center justify-between flex-shrink-0 border-b border-sidebar-border h-16">
            <div className="flex items-center gap-3">
              ...
              <h1 className="font-bold text-lg">Cypher</h1>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {isMobileMenuOpen ? <X size={24} className="flex-shrink-0"/> : <Menu size={24} className="flex-shrink-0"/>}
              </Button>
            </div>
          </div>
